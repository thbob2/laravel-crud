...
@section('header')
    <!-- Header -->
    <header class="header text-center text-white" style="background-image: linear-gradient(-225deg, #1b1b1b 0%, #323232 49%, #b22740 100%);">
            <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-8 col-xl-9">
                            <div class="row gap-y">
                                ...
                                @empty
                                <p class="text-center">
                                No result found for your request <strong>"{{request()->query('search')}}"</strong>
                                </p>
                                @endforelse
